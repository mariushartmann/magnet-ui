            ...
            <MagnetRow>
                <MagnetColumn>
                    <MagnetRadioGroup {...args}>
                        <MagnetRadio value="1" label="Value 1"></MagnetRadio>
                        <MagnetRadio value="2" label="Value 2"></MagnetRadio>
                        <MagnetRadio value="3" label="Value 3"></MagnetRadio>
                        <MagnetRadio value="4" label="Value 4"></MagnetRadio>
                    </MagnetRadioGroup>
                </MagnetColumn>
            </MagnetRow>
        </MagnetContainer>
...
WithRules.args = {
    ...
    onChange: undefined,
    row: false,
    rules: [(v) => !!v || "You have to select an option"],
    theme: "auto",
    value: undefined
} as IRadioGroupProps;
