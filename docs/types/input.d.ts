...
export interface IInputProps<TValue extends any = any, THtmlElement extends HTMLElement = HTMLElement, THtmlInnerElement extends HTMLElement = HTMLElement> extends IComponentProps, IClickable<React.MouseEvent<THtmlInnerElement>> {
    /**
...
export declare type InputValidationRule = (value: any) => string | boolean;
export declare type InputValidationRules = (InputValidationRule | string)[];
