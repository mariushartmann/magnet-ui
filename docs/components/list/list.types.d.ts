...
export interface IListItemProps extends IComponentProps, IThemable, IClickable<React.MouseEvent<HTMLElement>>, ILinkable {
    /**
...
export declare type ListItemColor = "primary" | "secondary" | "success" | "warning" | "error";
